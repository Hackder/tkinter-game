...
class ObjectLayoutTransition(Component, ABC):
    ...
    @abstractmethod
    def selector(self, entity: Entity, ctx: FrameContext, state: object | None) -> Transitionable:
        pass

    @abstractmethod
    def setter(self, entity: Entity, ctx: FrameContext, state: object | None, value: Transitionable):
        pass
...
class PositionTransition(ObjectTransition):
    ...
    def selector(self, entity: Entity, ctx: FrameContext, position: Position, size: Size, state: object | None) -> Position:
        return position

    def setter(self, entity: Entity, ctx: FrameContext, position: Position, size: Size, state: object | None, value: Position):
        position.x = value.x
        position.y = value.y
...
class SizeTransition(ObjectTransition):
    ...
    def selector(self, entity: Entity, ctx: FrameContext, position: Position, size: Size, state: object | None) -> Size:
        return size
